...
export default function BottomNavAura({ items, activePath, onItemClick, className, style }) {
  ...
  return (
    ...
    <nav
      ...
      className={cn(
        "relative mx-auto w-full max-w-max overflow-visible",
        className
      )}
      style={style}
    >
      <div className="relative flex items-center justify-center gap-1 rounded-full bg-white/50 p-1.5 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.1)] backdrop-blur-xl border border-white/40 dark:bg-black/40 dark:border-white/10 dark:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.5)]">
        ...
        >
          ...
          <div className="absolute inset-0 top-2 mx-auto w-4 rounded-full bg-indigo-500/20 blur-xl dark:bg-indigo-400/30" />
        ...
        {items.map((item, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative z-10 flex h-12 w-14 flex-col items-center justify-center",
                isActive
