      ...
      >
        <ul className="relative mx-auto flex w-full max-w-md items-center justify-between px-6 pt-2">
          {items.map((item, index) => {
            ...
            if (isCenter) {
              return (
                <li key={item.path} className="relative z-50 flex w-[4.25rem] shrink-0 items-center justify-center">
            ...
            return (
              <li key={item.path} className="relative z-10 flex flex-1 items-center justify-center">
                <button
                  aria-current={isActive ? "page" : undefined}
                  className={cn(
