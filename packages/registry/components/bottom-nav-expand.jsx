...
export default function BottomNavExpand({ items, activePath, onItemClick, className, style }) {
  ...
  return (
    <nav
      ...
      className={cn(
        "expand-nav-shell mobile-scale-nav relative flex items-center justify-end mr-4 w-full max-w-[calc(100%-2rem)] ml-auto",
        className
      )}
      style={style}
    >
        ...
        <button
          ...
          className={cn(
            ...
            isExpanded
              ...
              : "bg-indigo-500 text-white shadow-md hover:bg-indigo-600 rotate-0"
          )}
