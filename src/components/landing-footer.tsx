...
import { AtomIcon, GitIcon } from "../icons/dashboard-icons";
...
export function LandingFooter({ isLight }: LandingFooterProps) {
  ...
  return (
    <footer className={cn("mt-16 border-t", borderClass)}>
      <div className="mx-auto w-full py-10 sm:py-12">
        <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:gap-12">
            <div className="space-y-3">
              <p className={cn("text-[11px] font-semibold uppercase tracking-[0.2em]", isLight ? "text-slate-500" : "text-slate-400")}>
                Explore
              </p>
